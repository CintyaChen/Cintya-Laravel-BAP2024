    ...
    <body style="padding-top: 100px;" >
        <div class="row mt-4">
            <div class="col-12 text-center">
                ...
                <a href="/profilcintya" Class="btn btn-secondary" >Profile</a>
            </div>
        </div>
        <div class="container mt-4">
            ...
            <div class="row"> 
                <div class="col-12 mb-4"> 
                    <h1 class="text-center">Nama Mahasiswa: Cintya Chen</h1> 
                    <h2 class="text-center">Student ID: 03081220005</h2> 
                </div>
            </div>
